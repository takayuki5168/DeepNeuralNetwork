...
namespace MachineLearning
{
  ...
  public:
    ...
    {
      std::unique_ptr<LayerClass> layer = std::make_unique<LayerClass>(args...);
    ...
    template<class LossClass, class... ArgClass>
    void loss(ArgClass&&... args)
    {
      std::unique_ptr<LossClass> loss = std::make_unique<LossClass>(args...);
